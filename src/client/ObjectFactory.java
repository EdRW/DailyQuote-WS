...
public class ObjectFactory {
    ...
    private final static QName _GetQuoteResponse_QNAME = new QName("http://service/", "getQuoteResponse");
    private final static QName _GetQuote_QNAME = new QName("http://service/", "getQuote");
    private final static QName _AddQuote_QNAME = new QName("http://service/", "addQuote");
    private final static QName _AddQuoteResponse_QNAME = new QName("http://service/", "addQuoteResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service/", name = "getQuoteResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service/", name = "getQuote")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service/", name = "addQuote")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service/", name = "addQuoteResponse")
